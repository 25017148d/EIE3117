...
const isMyRoute = computed(
  () => currentRoute.value?.driverId === userStore.user?.id,
);
const isBooked = computed(() => currentRoute.value?.isBooked ?? false);
    ...
    <main class="flex-grow py-10">
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div v-if="!currentRoute" class="text-center py-12">
          ...
          <div class="mt-6">
            <router-link to="/" class="text-primary hover:text-blue-600"
          ...
          <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
            <dl class="sm:divide-y sm:divide-gray-200">
              <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                >
                  <img
                    ...
                    :src="
                      currentRoute.driverAvatar ||
                      `https://i.pravatar.cc/150?u=${currentRoute.driverId}`
                    "
                    alt=""
                  />
              ...
              <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  {{ currentRoute.date }} at {{ currentRoute.time }}
                </dd>
              </div>
              ...
              <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  {{ currentRoute.availableSeats }} available /
                  {{ currentRoute.totalSeats }} total
                </dd>
              </div>
              ...
              <div
                v-if="isDriver && isMyRoute"
                class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 bg-gray-50"
              >
                <dt class="text-sm font-medium text-gray-500">Passengers</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <ul
                    v-if="
                      currentRoute.passengerDetails
                        ? currentRoute.passengerDetails.length > 0
                        : currentRoute.passengers.length > 0
                    "
                    class="border border-gray-200 rounded-md divide-y divide-gray-200"
                  >
                    <li
                      v-for="passenger in currentRoute.passengerDetails || []"
                      :key="passenger.id"
                    ...
                    <li
                      v-for="passengerId in currentRoute.passengerDetails
                        ? []
