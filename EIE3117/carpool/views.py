...
# ---- Authentication helpers: place refresh token into an HttpOnly cookie ----
class CookieTokenObtainPairView(TokenObtainPairView):
    permission_classes = [AllowAny]

    def post(self, request, *args, **kwargs):
        resp = super().post(request, *args, **kwargs)
        # On success, SimpleJWT returns access and refresh. Move refresh into httponly cookie.
...
class CookieTokenRefreshView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # If a (rotated) refresh token is returned in validated_data, set it into the cookie.
        ...
        # If no new refresh returned but a cookie existed, keep it unchanged.
        return response
